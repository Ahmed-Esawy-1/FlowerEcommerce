         ...
         <>
            ...
            <section className="flex justify-between items-end">
               <div>
                  ...
                  <p className="page-subtitle">
                     Monitoring key performance indicators and operational
                     metrics.
                  </p>
               </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-8">
               <div className="bg-surface-container border border-surface-variant p-8 rounded-xl shadow-sm h-42">
                  ...
                  <h3 className="text-2xl font-bold mt-1.5">$128,430.00</h3>
               </div>
               ...
               <div className="bg-surface-container border border-surface-variant p-8 rounded-xl shadow-sm h-42">
                  ...
                  <h3 className="text-2xl font-bold mt-1.5">2,845</h3>
               </div>
               ...
               <div className="bg-surface-container border border-surface-variant p-8 rounded-xl shadow-sm h-42">
                  ...
                  <h3 className="text-2xl font-bold mt-1.5">3.24%</h3>
               </div>
            </div>
                        ...
                        <div className="flex gap-4" key={i}>
                           ...
                           <div className="space-y-1">
                              <p className="text-on-surface">
                                 New order{" "}
                                 <span className="font-semibold">#12904</span>
                                 <br />
                                 received
                              </p>
                              <p className="text-secondary">
                                 2 minutes ago • $240.00
                              </p>
                           </div>
                        </div>
                     ))}
