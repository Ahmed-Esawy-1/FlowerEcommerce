...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 h-full flex flex-col bg-white w-[280px] border-r border-slate-200 shadow-sm">
      <div className="px-6 py-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-secondary">Enterprise Admin</p>
          </div>
        </div>
