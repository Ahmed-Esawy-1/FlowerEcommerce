            ...
            <SwiperSlide key={i}>
               <div className="product-card group relative">
                  <div className="aspect-[3/4] rounded-2xl overflow-hidden relative mb-4 bg-slate-50">
                     {product.status != null ? (
                        <span className="absolute top-4 left-4 bg-white/90 backdrop-blur text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full z-10">
                           {product.status}
                        </span>
                     ) : (
                        ""
                     ...
                     <div className="product-action absolute bottom-6 left-0 right-0 px-6">
                        <button
                           className="cursor-pointer w-full bg-slate-900 text-whitepy-3 rounded-xl font-bold flex items-center justify-center gap-2 shadow-2xl
                  "
