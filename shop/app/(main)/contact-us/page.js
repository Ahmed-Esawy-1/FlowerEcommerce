        ...
        <main className="flex-1">
          <div className="relative w-full h-[409px] bg-slate-900 overflow-hidden">
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
              ...
              <h1 className="text-4xl md:text-6xl font-serif font-light text-slate-900 dark:text-slate-100 mb-4 italic">
                Get in Touch
              </h1>
              <p className="max-w-xl text-slate-600 dark:text-slate-400 font-display leading-relaxed">
                For bespoke arrangements, corporate partnerships, or simple
                inquiries about our daily collections.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <div className="space-y-12">
                <div className="space-y-6">
                  <h3 className="text-2xl font-serif text-slate-900 dark:text-slate-100 italic">
                    Our Atelier
                  </h3>
              ...
              <div className="bg-white dark:bg-background-dark/50 p-8 md:p-12 rounded-2xl shadow-2xl border border-primary/5">
                <form className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-widest">
                        Full Name
                      </label>
                      <input
                        className="w-full bg-transparent border-0 border-b border-slate-200 dark:border-slate-800 focus:ring-0 focus:border-primary px-0 py-3 text-slate-900 dark:text-slate-100 placeholder:text-slate-400"
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-transparent border-0 border-b border-slate-200 dark:border-slate-800 focus:ring-0 focus:border-primary px-0 py-3 text-slate-900 dark:text-slate-100 appearance-none">
                      <option className="dark:bg-background-dark">
                        General Inquiry
                      </option>
                      <option className="dark:bg-background-dark">
                        Bespoke Arrangement
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      className="w-full bg-transparent border-0 border-b border-slate-200 dark:border-slate-800 focus:ring-0 focus:border-primary px-0 py-3 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 resize-none"
