         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-5 space-y-8">
               ...
               <div className="space-y-6">
                  <div className="p-6 border border-slate-100  rounded-xl bg-slate-50/50 /50">
                     <label className="block text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">
                        Select Size
                     </label>
                     <div className="flex items-center justify-between p-4 border-2 border-primary rounded-lg bg-white ">
                  ...
                  <div className="flex gap-4">
                     <div className="flex-1 p-6 border border-slate-100  rounded-xl bg-slate-50/50 /50 flex flex-col justify-center">
               ...
               <div className="space-y-4 border-t border-slate-100  pt-8">
                  ...
                  <div className="grid grid-cols-1 gap-3">
                     <div className="p-4 border border-slate-100  rounded-xl flex items-center justify-between hover:bg-slate-50  transition-colors group">
                        <div className="flex items-center gap-4">
                           <div className="w-10 h-10 bg-white  rounded-lg shadow-sm border border-slate-100  flex items-center justify-center font-bold italic text-blue-600">
                              valU
                           </div>
                           <div>
                     ...
                     <div className="p-4 border border-slate-100  rounded-xl flex items-center justify-between hover:bg-slate-50  transition-colors group relative overflow-hidden">
