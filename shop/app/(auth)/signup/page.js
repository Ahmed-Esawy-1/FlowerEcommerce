      ...
      <div className="relative hidden lg:flex lg:w-1/2 items-center justify-center bg-primary/10 overflow-hidden">
        ...
        <div className="relative z-10 px-12 text-center text-white">
          ...
          <p className="text-xl font-light max-w-md mx-auto opacity-90">
            Experience the art of premium floral gifting, curated with passion
      ...
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-24 bg-background-light dark:bg-background-dark">
        <div className="mx-auto w-full max-w-md">
          ...
          <form action="#" className="space-y-6" method="POST">
            ...
            <div>
              <label
                className="block text-sm font-semibold leading-6 text-slate-900 dark:text-slate-100 mb-2"
                htmlFor="full-name"
              >
                Full Name
              </label>
              <div className="relative">
                ...
                <input
                  autoComplete="name"
                  className="block w-full rounded-xl border-0 outline-none py-4 pl-12 pr-4 text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-200 dark:ring-slate-700 bg-white dark:bg-slate-800/50 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                  id="full-name"
                  name="full-name"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-xl border-0 outline-none py-4 pl-12 pr-12 text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-200 dark:ring-slate-700 bg-white dark:bg-slate-800/50 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                  id="password"
                  name="password"
                  placeholder="••••••••"
                  required
          ...
          <div className="mt-10">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <a
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-white dark:bg-slate-800/50 px-3 py-3 text-sm font-semibold text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-200 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                href="#"
              >
